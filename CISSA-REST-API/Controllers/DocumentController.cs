...
namespace ASIST_REPORT_REST_API.Controllers
{
    public class DocumentController : ApiController
    {
        ...
        [HttpGet]
        public IHttpActionResult Report_112(Guid districtId, Guid? djamoatId = null)
        {
            try
            {
                return Ok(ScriptExecutor.Report_112.Execute(districtId, djamoatId));
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult Report10v(/*[FromUri] DateTime fd, [FromUri] DateTime ld*/)
        {
            try
            {
                return Ok(ScriptExecutor.Report10v.Execute(/*fd, ld*/));
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_1()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_1.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_2()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_2.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_3()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_3.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_4()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_4.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_5()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_5.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_6()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_6.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_7()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_7.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_8()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_8.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_9()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_9.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
        ...
        [HttpGet]
        public IHttpActionResult StateReport_10()
        {
            try
            {
                return Ok(ScriptExecutor.StateReport_10.Execute());
            }
            catch (Exception e)
            {
                return BadRequest(e.GetBaseException().Message);
